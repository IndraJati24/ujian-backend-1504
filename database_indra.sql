...
CREATE TABLE `movies` (
  ...
  PRIMARY KEY (`id`),
  KEY `movie_status_idx` (`status`),
  CONSTRAINT `movie_status` FOREIGN KEY (`status`) REFERENCES `movie_status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `schedules` (
  ...
  PRIMARY KEY (`id`),
  KEY `movie_schedules_idx` (`movie_id`),
  KEY `locatio_schedules_idx` (`location_id`),
  KEY `time_schedules_idx` (`time_id`),
  CONSTRAINT `locatio_schedules` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `movie_schedules` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `time_schedules` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `schedules` VALUES (1,1,1,3),(2,1,1,4),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,4),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,1,1),(29,9,1,2),(31,9,1,3),(32,9,2,3);
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `user_status` FOREIGN KEY (`status`) REFERENCES `status` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `users` VALUES (1,'1612335768512','indra24','indra@mail.com','51142384bed9c55d8b6fd77147c29421',2,2),(3,'1612335916171','jati24','jati@mail.com','c7685f6eb9b6f3a787c1050dcad8b011',2,3),(4,'1612338699173','sari24','sari@mail.com','ef402b4026feef502dfad201467b71fe',1,1);
...
-- Dump completed on 2021-02-03 17:16:59
